...
namespace Screenshot.Widgets {
    public class SelectionArea : Granite.Widgets.CompositedWindow {
        ...
        public ScreenshotWindow.CaptureTypeNew capture_mode = ScreenshotWindow.CaptureTypeNew.AREA;
        ...
        public override bool key_press_event (Gdk.EventKey e) {
            ...
            if (e.state == Gdk.ModifierType.CONTROL_MASK && e.keyval == Gdk.Key.a) {
                capture_mode = ScreenshotWindow.CaptureTypeNew.SCREEN;
                captured ();
            }
